...
set _xil_proj_name_ "cva5_abacus_wrapper_IP"
...
# Create project
create_project ${_xil_proj_name_} $origin_dir/${_xil_proj_name_} -part xcvu9p-flga2104-2-i-es1
...
import_files -norecurse $origin_dir/../../examples/xilinx/xilinx_wrapper.sv -force
...
ipx::update_checksums [ipx::current_core]
ipx::save_core [ipx::current_core]
current_project cva5_abacus_wrapper_IP
set_property "ip_repo_paths" "[file normalize "$origin_dir/cva5_abacus_wrapper_IP"]" $obj
update_ip_catalog -rebuild
